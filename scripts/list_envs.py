...
All the environments are registered in the `rl_anymal_loco_isaac` extension. They start
...
import rl_anymal_loco_isaac.tasks  # noqa: F401


def main():
    """Print all environments registered in `rl_anymal_loco_isaac` extension."""
